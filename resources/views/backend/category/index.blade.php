            ...
            @foreach($categories as $category)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        @if($category->photo)
                            <img src="{{$category->photo}}" class="img-fluid" style="width:80px" alt="{{$category->photo}}">
                        @else
                            <img src="{{asset('backend/img/thumbnail-default.jpg')}}" class="img-fluid" style="max-width:20px" alt="avatar.png">
                        @endif
                    </td>
                    <td>
